...
function GlobeGlyph(props: IconProps) {
  return (
    <Stroke {...props}>
...
function WhatsAppGlyph(props: IconProps) {
  return (
    <Fill {...props}>
...
function ChatGlyph(props: IconProps) {
  return (
    <Stroke {...props}>
...
/** Recognizable per-platform glyph for a contact row. Monochrome (currentColor)
 *  so rows stay calm and professional; shape carries the identity. */
export function ContactIcon({
  ...
  switch (platform) {
    case 'PHONE':
      return <PhoneGlyph className={className} />;
    case 'WEBSITE':
      return <GlobeGlyph className={className} />;
    case 'INSTAGRAM':
    ...
    case 'OTHER':
    default:
      return <ChatGlyph className={className} />;
  }
}
